    ...
    <Layout title='Terms and Conditions - Youfy'>
      <div className='container page terms'>
        ...
        <p>
          ...
          <a target='_blank' rel='nofollow' href='http://youfyapp.com'>
            youfyapp.com
          </a>
          website (&quot;Website&quot;), &quot;youfy&quot; mobile application
          ...
          Agreement and may not access and use the Services. You acknowledge
          that this Agreement is a contract between you and the Operator, even
        ...
        <p>
          ...
          herein. Some of the links on the Services may be &quot;affiliate
          links&quot;. This means if you click on the link and purchase an item,
          the Operator will receive an affiliate commission. We are not
        ...
        <p>
          ...
          graphics and logos used in connection with the Services, are
        ...
        <p>
          ...
          and procedural laws of Ontario, Canada without regard to its rules on
          conflicts or choice of law and, to the extent applicable, the laws of
          Canada. The exclusive jurisdiction and venue for actions related to
          the subject matter hereof shall be the courts located in Ontario,
          Canada, and you hereby submit to the personal jurisdiction of such
        ...
        <p>
          ...
          of this Agreement on the Services. When we do, we will post a
          notification within the Services. Continued use of the Services after
        ...
        <p>
          ...
          you may send an email to you&#102;ya&#112;p&#64;gma&#105;l.c&#111;m.
        </p>
        <p>This document was last updated on March 31, 2021</p>
      </div>
    </Layout>
  );
};
